...
const heroShop = 'https://mwymquhbuljossskekoj.supabase.co/storage/v1/object/public/barberos/locales/principedegales/foto-4.jpeg'
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[92vh] min-h-[640px] w-full overflow-hidden">
        ...
        <div className="container-wide relative z-10 flex h-full flex-col justify-center pb-20">
          <div className="flex items-center gap-3 mb-6 animate-fade-up">
            <span className="text-[#DD873C] text-xs">◆</span>
          ...
          <h1 className="display leading-[0.95] text-bone animate-fade-up" style={{ animationDelay: '100ms' }}>
            ...
            <span className="block whitespace-nowrap" style={{ fontSize: 'clamp(1.8rem, 4vw, 4.5rem)' }}>
              BARBERÍA.{' '}
              <span style={{ fontFamily: 'Playfair Display, serif', fontStyle: 'italic', fontWeight: 400, color: '#DD873C' }}>Es un hub.</span>
            </span>
          </h1>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4 animate-fade-up" style={{ animationDelay: '300ms' }}>
            <Button asChild size="lg" className="bg-gradient-to-r from-[#DD873C] to-[#B5611A] text-[#000000] font-semibold uppercase tracking-[0.15em] hover:opacity-90 transition-opacity rounded-sm px-8">
              <a href="#barberos">
        ...
        {/* Marquee */}
        <div className="absolute bottom-0 left-0 right-0 z-10 overflow-hidden border-y border-[#DD873C]/20 bg-[#000000]/85 backdrop-blur py-3">
              ...
              <div key={i} className="flex shrink-0 items-center gap-0 px-0">
                {marqueeItems.map((t) => (
                  <span key={t} className="display text-lg tracking-[0.25em] text-[#F7F4EF]/50 px-5">
                    {t} <span className="text-[#DD873C] mx-2">◆</span>
                  </span>
                ))}
              </div>
            ))}
      ...
      <section className="container-wide py-20 md:py-28">
        <div className="grid gap-4 md:grid-cols-2 mb-16">
          <div>
            ...
            <h2 className="display text-4xl md:text-6xl text-[#F7F4EF]">
              ...
              <span style={{ fontFamily: 'Playfair Display, serif', fontStyle: 'italic', fontWeight: 400 }} className="copper-text">
                independiente florece.
              </span>
            </h2>
          </div>
          <div className="flex flex-col justify-end">
            <p className="text-[#F2D1AA] leading-relaxed max-w-md">
        ...
        <div className="grid gap-px bg-[#DD873C]/10 border border-[#DD873C]/10 md:grid-cols-4">
          {[
            ...
            <div key={s.l} className="bg-background p-8">
              <p className="display text-5xl md:text-6xl copper-text leading-none">{s.k}</p>
              <p className="mt-3 text-sm uppercase tracking-[0.18em] text-[#F7F4EF]">{s.l}</p>
              <p className="mt-1 text-xs text-[#F2D1AA]/60">{s.d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* ── GOOGLE REVIEWS ───────────────────────────────────────────────── */}
      <section className="bg-[#000000] border-y border-[#DD873C]/10 py-16">
        <div className="container-wide">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-10 gap-4">
            ...
            <div className="flex items-center gap-2">
              {[...Array(5)].map((_, i) => <Star key={i} className="h-5 w-5 fill-[#DD873C] text-[#DD873C]" />)}
              <span className="ml-2 text-sm text-[#F2D1AA]/60">Google Reviews</span>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden">
            <div className="transition-all duration-500">
              <div className="rounded-sm border border-[#DD873C]/15 bg-[#111] p-8 md:p-10 max-w-2xl">
                <Quote className="h-8 w-8 text-[#DD873C] mb-4 opacity-60" />
                ...
                <div className="mt-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[#DD873C] uppercase tracking-[0.18em] mt-0.5">{googleReviews[reviewIndex].local}</p>
                  </div>
                  <div className="flex gap-1">
                    {[...Array(5)].map((_, i) => <Star key={i} className="h-3.5 w-3.5 fill-[#DD873C] text-[#DD873C]" />)}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-2 mt-6">
              {googleReviews.map((_, i) => (
                <button key={i} onClick={() => setReviewIndex(i)}
                  className={cn('h-1.5 rounded-full transition-all', i === reviewIndex ? 'w-8 bg-[#DD873C]' : 'w-1.5 bg-[#DD873C]/30 hover:bg-[#DD873C]/60')} />
              ))}
            </div>
          </div>
        </div>
      ...
      <section id="barberos" className="container-wide py-16 scroll-mt-24">
        <div className="mb-10">
          ...
          <p className="mt-3 max-w-xl text-[#F2D1AA]/70">
            ...
            <button key={loc.value} onClick={() => setActiveLocal(loc.value)}
              className={cn('rounded-sm border px-4 py-2 text-[11px] uppercase tracking-[0.2em] transition-all',
                activeLocal === loc.value
                  ? 'bg-gradient-to-r from-[#DD873C] to-[#B5611A] text-[#000000] border-transparent font-semibold'
                  : 'border-[#DD873C]/20 text-[#F7F4EF]/70 hover:border-[#DD873C]/60 hover:text-[#DD873C]'
              )}>
              {loc.label}
            </button>
          ))}
      ...
      {/* ── SERVICIOS ────────────────────────────────────────────────────── */}
      <section id="servicios" className="bg-[#000000] border-y border-[#DD873C]/10 mt-16 scroll-mt-24">
        <div className="container-wide py-20 md:py-28">
          <div className="mb-12">
            ...
            <p className="mt-3 max-w-xl text-[#F2D1AA]/60">
              Resultados consistentes y atención excepcional. Sin complicaciones ni atajos. Solo calidad.
            </p>
          </div>

          <div className="grid gap-px bg-[#DD873C]/10 border border-[#DD873C]/10 md:grid-cols-2 lg:grid-cols-3">
            {serviceCatalog.map((srv) => (
              <div key={srv.name} className="group bg-[#000000] p-6 hover:bg-[#111]/80 transition-colors">
                ...
                <p className="text-sm text-[#F2D1AA]/60 leading-relaxed mb-4">{srv.desc}</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.2em] text-[#F2D1AA]/50">
                    {srv.duration && <><Clock className="h-3.5 w-3.5" /> {srv.duration} min</>}
                  </div>
                  {srv.price ? (
                    <p className="display text-2xl copper-text">{formatCLP(srv.price)}</p>
                  ) : (
                    <p className="text-xs uppercase tracking-[0.18em] text-[#DD873C]">Consultar</p>
                  )}
                </div>
              </div>
            ))}
          ...
          <div className="mt-10 flex justify-center">
            <a href={AGENDAPRO_URL} target="_blank" rel="noopener noreferrer"
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-[#DD873C] to-[#B5611A] text-[#000000] font-semibold uppercase tracking-[0.15em] text-sm rounded-sm px-8 py-3 hover:opacity-90 transition-opacity">
      ...
      <section id="portafolio" className="container-wide py-20 md:py-28 scroll-mt-24">
        ...
        <div className="relative aspect-[16/7] overflow-hidden rounded-sm bg-[#111] mb-3">
          ...
          <div className="absolute bottom-4 left-5">
            <p className="text-[11px] uppercase tracking-[0.2em] text-[#DD873C]">◆ {localPhotos[carouselIndex]?.local}</p>
          ...
          <button onClick={() => setCarouselIndex(i => (i - 1 + localPhotos.length) % localPhotos.length)}
            className="absolute left-3 top-1/2 -translate-y-1/2 h-9 w-9 flex items-center justify-center rounded-sm bg-[#000]/60 text-[#DD873C] hover:bg-[#DD873C] hover:text-[#000] transition-all text-xl">‹</button>
          <button onClick={() => setCarouselIndex(i => (i + 1) % localPhotos.length)}
            className="absolute right-3 top-1/2 -translate-y-1/2 h-9 w-9 flex items-center justify-center rounded-sm bg-[#000]/60 text-[#DD873C] hover:bg-[#DD873C] hover:text-[#000] transition-all text-xl">›</button>
        </div>
          ...
          {localPhotos.map((p, i) => (
            <button key={i} onClick={() => setCarouselIndex(i)}
              className={cn('relative aspect-square overflow-hidden rounded-sm transition-all',
                carouselIndex === i ? 'ring-2 ring-[#DD873C] opacity-100' : 'opacity-50 hover:opacity-80')}>
      ...
      <section id="ubicaciones" className="container-wide py-20 md:py-28 scroll-mt-24">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {locations.map((loc) => (
            <a key={loc.name} href={loc.maps} target="_blank" rel="noopener noreferrer"
              ...
              className="group block rounded-sm border border-[#DD873C]/10 bg-[#000000] p-6 hover:border-[#DD873C]/40 transition-all">
              <div className="flex items-start justify-between mb-4">
                <MapPin className="h-5 w-5 text-[#DD873C]" />
                <span className="text-[#DD873C] text-xs group-hover:translate-x-1 transition-transform">◆</span>
              </div>
              <p className="text-[10px] uppercase tracking-[0.22em] text-[#DD873C]/60 mb-1">{loc.label}</p>
              <p className="display text-2xl leading-tight text-[#F7F4EF]">{loc.name}</p>
              <p className="mt-3 text-sm text-[#F7F4EF]/70">{loc.street}</p>
              <p className="text-xs text-[#F2D1AA]/50">{loc.area}</p>
              <div className="mt-5 text-[11px] uppercase tracking-[0.2em] text-[#DD873C]">Ver en mapa →</div>
            </a>
          ))}

          {/* 6to local */}
          <div className="rounded-sm border border-dashed border-[#DD873C]/30 bg-[#DD873C]/5 p-6 flex flex-col justify-center">
            <span className="inline-flex items-center gap-1.5 rounded-sm bg-[#DD873C]/15 px-2.5 py-1 text-[10px] uppercase tracking-[0.18em] text-[#DD873C] font-semibold w-fit">
              ◆ 6º Local en camino
            </span>
        ...
        <div className="mt-10 flex items-center gap-3 text-sm text-[#F2D1AA]/50 border-t border-[#DD873C]/10 pt-6">
          <Calendar className="h-4 w-4 text-[#DD873C]" />
          <span>Abiertos todo el año, excepto feriados irrenunciables.</span>
        </div>
      </section>

      {/* ── FRANQUICIA ───────────────────────────────────────────────────── */}
      <section id="franquicia" className="bg-[#000000] border-y border-[#DD873C]/10 scroll-mt-24">
        <div className="container-wide py-20 md:py-28">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="mt-6 text-[#F2D1AA] leading-relaxed max-w-lg">
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  <li key={item.t} className="flex gap-4">
                    <span className="text-[#DD873C] mt-0.5 shrink-0">{item.icon}</span>
                    <div>
                      <p className="text-sm font-semibold text-[#F7F4EF] uppercase tracking-[0.15em]">{item.t}</p>
                      <p className="text-xs text-[#F2D1AA]/60 mt-0.5">{item.d}</p>
                    </div>
                  </li>
                ))}
              </ul>
              <div className="mt-10 flex flex-wrap gap-3">
                ...
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 border border-[#DD873C]/30 text-[#DD873C] font-semibold uppercase tracking-[0.15em] text-sm rounded-sm px-6 py-3 hover:border-[#DD873C] transition-colors">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={s.l} className="rounded-sm border border-[#DD873C]/10 bg-[#111] p-6">
                  <p className="display text-4xl copper-text leading-none">{s.k}</p>
                  <p className="mt-2 text-sm uppercase tracking-[0.15em] text-[#F7F4EF]">{s.l}</p>
                  <p className="mt-1 text-xs text-[#F2D1AA]/50">{s.d}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ── CONTACTO ─────────────────────────────────────────────────────── */}
      <section id="contacto" className="border-t border-[#DD873C]/10 scroll-mt-24">
        <div className="container-wide py-20 md:py-28">
          <div className="grid gap-16 lg:grid-cols-2">
            <div>
              ...
              {contactSent ? (
                <div className="rounded-sm border border-[#DD873C]/30 bg-[#DD873C]/10 p-8 text-center">
                  <p className="display text-3xl text-[#DD873C]">◆ Mensaje enviado</p>
                  <p className="mt-3 text-[#F2D1AA]/70">Te respondemos a la brevedad en info@labarberia.cl</p>
                  <button onClick={() => setContactSent(false)} className="mt-6 text-xs uppercase tracking-[0.2em] text-[#DD873C] hover:underline">
                    Enviar otro mensaje
                  </button>
                </div>
              ) : (
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  <div>
                    <label className="text-[11px] uppercase tracking-[0.2em] text-[#F2D1AA]/60 block mb-2">Nombre</label>
                    <input required value={contactForm.name}
                      onChange={e => setContactForm(f => ({ ...f, name: e.target.value }))}
                      className="w-full rounded-sm border border-[#DD873C]/20 bg-[#111] px-4 py-3 text-sm text-[#F7F4EF] focus:border-[#DD873C]/60 focus:outline-none transition-colors"
                      placeholder="Tu nombre" />
                  </div>
                  <div>
                    <label className="text-[11px] uppercase tracking-[0.2em] text-[#F2D1AA]/60 block mb-2">Email</label>
                  ...
                  <div>
                    <label className="text-[11px] uppercase tracking-[0.2em] text-[#F2D1AA]/60 block mb-2">Mensaje</label>
                    <textarea required rows={4} value={contactForm.message}
                      onChange={e => setContactForm(f => ({ ...f, message: e.target.value }))}
                      className="w-full rounded-sm border border-[#DD873C]/20 bg-[#111] px-4 py-3 text-sm text-[#F7F4EF] focus:border-[#DD873C]/60 focus:outline-none transition-colors resize-none"
            ...
            <div>
              ...
              <p className="text-[#F2D1AA]/60 leading-relaxed mb-8">
              ...
              {cvSent ? (
                <div className="rounded-sm border border-[#DD873C]/30 bg-[#DD873C]/10 p-8 text-center">
                  <p className="display text-3xl text-[#DD873C]">◆ CV enviado</p>
                  <p className="mt-3 text-[#F2D1AA]/70">Lo revisamos y te contactamos si hay match.</p>
                  <button onClick={() => setCvSent(false)} className="mt-6 text-xs uppercase tracking-[0.2em] text-[#DD873C] hover:underline">
                    Enviar otro
                  </button>
                </div>
              ) : (
                <form onSubmit={handleCvSubmit} className="space-y-4">
                  <div onClick={() => fileRef.current?.click()}
                    className="cursor-pointer rounded-sm border border-dashed border-[#DD873C]/30 bg-[#DD873C]/5 p-8 text-center hover:border-[#DD873C]/60 transition-colors">
                    <Upload className="h-8 w-8 text-[#DD873C] mx-auto mb-3" />
                    <p className="text-[#F7F4EF] text-sm font-medium">
                      {cvFile ? cvFile.name : 'Haz clic para cargar tu CV'}
                    </p>
                    <p className="text-[#F2D1AA]/50 text-xs mt-1">PDF, DOC hasta 10MB</p>
                    <input ref={fileRef} type="file" accept=".pdf,.doc,.docx" className="hidden"
                      onChange={e => setCvFile(e.target.files?.[0] ?? null)} />
                  </div>
                  <button type="submit" disabled={!cvFile}
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-[#DD873C] to-[#B5611A] text-[#000000] font-semibold uppercase tracking-[0.15em] text-sm rounded-sm px-8 py-3 hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed">
                    <ChevronRight className="h-4 w-4" /> Enviar postulación
                  </button>
                </form>
              )}

              <div className="mt-8 border-t border-[#DD873C]/10 pt-6 space-y-3">
                <p className="text-[11px] uppercase tracking-[0.2em] text-[#F2D1AA]/40">O escríbenos directo</p>
                <a href="mailto:info@labarberia.cl" className="flex items-center gap-2 text-sm text-[#DD873C] hover:underline">
                  info@labarberia.cl
                </a>
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
                  onClick={() => trackExternalLink('whatsapp_contacto')}
                  className="flex items-center gap-2 text-sm text-[#DD873C] hover:underline">
      ...
      <button
        ...
        className={cn(
          'fixed bottom-24 right-6 z-50 flex h-11 w-11 items-center justify-center rounded-sm border border-[#DD873C]/30 bg-[#000000]/80 backdrop-blur text-[#DD873C] shadow-lg transition-all hover:border-[#DD873C] hover:bg-[#111]',
